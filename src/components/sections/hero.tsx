            ...
            <>
              <div>
                ...
                <BlurIn delay={1.2}>
                  ...
                  <p
                    className={cn(
                      "md:self-start mt-3 font-thin text-sm text-slate-400 dark:text-zinc-500 ml-3 max-w-md",
                      "cursor-default font-display "
                    )}
                  >
                    Aprendiendo ofensiva y defensiva, usando IA para automatizar todo lo que se pueda.
                  </p>
                </BlurIn>
              </div>
