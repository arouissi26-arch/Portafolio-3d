    ...
    <section id="contact" className="min-h-screen max-w-7xl mx-auto ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 z-[9999]">
        <Card className="min-w-7xl bg-white/70 dark:bg-black/70 backdrop-blur-sm rounded-xl mt-10 md:mt-20">
          <CardHeader>
            <CardTitle className="text-4xl">Formulario de Contacto</CardTitle>
            <CardDescription>
              Si quieres colaborar en proyectos, prácticas de ciberseguridad,
              scripts de automatización o webs básicas, escríbeme a{" "}
              <a
                target="_blank"
